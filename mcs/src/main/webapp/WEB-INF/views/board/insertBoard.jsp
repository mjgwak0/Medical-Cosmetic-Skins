...
<body>
    <div class="container">
        ...
        <div class="row body">
            <form id="frm" name="frm" method="post" action="/board/productInfo">
                <ul>
                    <li>
                        <p>
                            <label>글유형</label>
                    ...
                    <li><label for="comments">내용 <span class="req">*</span></label>
                        <textarea cols="46" rows="5" name="board_content" placeholder="내용을 입력해주세요."></textarea>
                    </li>
                    <li>
                        <p>
                            <label>답변상태</label>
                    ...
                    <li><input class="btn btn-submit" type="submit" onclick="next()" value="Submit" />
                    </li>
