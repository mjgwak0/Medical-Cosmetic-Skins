            ...
            <ul class="sideMenu">
                ...
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-store"></span>주문관리</a>
                    <ul class="submenu" style="display: block;">
                        ...
                        <li><a href="/company/orderCancelList" style="background: rgba(255,255,255,0.5);"><span class="fa fa-magnifying-glass"></span>취소정보</a></li>
                    </ul>
                </li>
        ...
        <div class="mainArea">
            ...
            <div class="mainContent">
                ...
                <div class="formHeader row">
                    <h2 class="text-1 fl">Cancle List</h2>
                    <div class="fr">
                        <!--                        
                ...
                <form action="" method="GET" name="listForm">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td class="row bg-1 text-fff" style="width: 100px; text-align: center">취소사유</td>
                                <td class="td">
                                    <button>전체</button>
                                    <button>고객변심</button>
                                    <button>품절</button>
                            ...
                            <tr>
                                ...
                                <td class="td">
                                    ...
                                    <input class=textform type=text name=search id="search_box" autocomplete="off" value="" placeholder="주문번호를 입력하세요." required>
<!--
...
-->
                ...
                <form action="" method="GET" name="listForm" class="form scrollX">
                    ...
                    <div class="table" style="min-width: 1300px">
                        <div class="row bg-1">
                            <div class="cell cell-100 text-fff">취소사유</div>
                            <div class="cell cell-150 text-fff">주문번호</div>
                            <div class="cell cell-100p text-fff">제품명</div>
                            <div class="cell cell-200 text-fff">취소요청일</div>
                            <div class="cell cell-150 text-fff">취소완료일</div>
                            <div class="cell cell-150 text-fff">제품가격</div>
                            <div class="cell cell-50 text-fff">수량</div><div class="cell cell-150 text-fff">처리상태</div>
                            <div class="cell cell-100 text-fff">EDIT
                            </div>
                        </div>
                        <!--   BEGIN LOOP -->
                        <ul>
                            <li class="row">
                                <div class="cell cell-100">시스템오류</div>
                                <div class="cell cell-150">202203300001</div>
                                <div class="cell cell-100p">브라이트닝 업 선 플러스 50ml</div>
                                <div class="cell cell-200">2022-03-31 09:40:10</div>
                                <div class="cell cell-150">2022-03-31 09:40:30</div>
                                <div class="cell cell-150">240,000원</div>
                                <div class="cell cell-50">1</div>
