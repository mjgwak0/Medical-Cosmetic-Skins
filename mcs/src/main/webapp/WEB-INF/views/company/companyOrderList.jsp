            ...
            <div class="mainContent">
                ...
                <form action="" method="GET" name="listForm">
                    <table>
                        <tbody>
                            <tr>
                                <td class="row bg-1 text-fff" style="width: 100px; text-align: center">진행상태</td>
                                <td class="td">
                                    <button>전체</button>
                                    <button>주문접수</button>
                                    <button>결제완료</button>
                            ...
                            <tr>
                                <td class="row bg-1 text-fff" style="text-align: center">기간</td>
                                <td class="td">
                                    <p>
                                        <input type=date value="<?=$date1?>" style="width: 150px">
                                        &nbsp~&nbsp
                                        <input type=date value="<?=$date2?>" style="width: 150px">
                                        <button>오늘</button>
                                        <button>어제</button>
                                        <button>1주일</button>
                                        <button>1개월</button>
                            ...
                            <tr>
                                <td class="row bg-1 text-fff" style="text-align: center">조건검색</td>
                                <td class="td">
                                    ...
                                    <input class=textform type=text name=search id="search_box" autocomplete="off" value="" placeholder="주문자명을 입력하세요." required>
<!--
...
-->
                    ...
                    <div style="height: 30px; display:table-cell; vertical-align:middle; ;">
                        <d>총 주문 수 : ${orderSize} /</d>
                        <d>검색 주문 수 : ${orderSize}</d>
                        <d>배송상태 변경은 상세페이지에서 진행해주세요.</d>
                    </div>
                </form>
                <form action="" method="GET" name="listForm" class="form scrollX">
                    ...
                    <div class="table" style="min-width: 100%">
                        <div class="row bg-1">
                            <div class="cell cell-150 text-fff">주문일</div>
                            <div class="cell cell-150 text-fff">주문번호</div>
                            <div class="cell cell-150 text-fff">주문자명</div>
                            <div class="cell cell-150 text-fff">주문자아이디</div>
                            <div class="cell cell-150 text-fff">주문방법</div>
                            <div class="cell cell-100 text-fff">EDIT</div>
                            <div class="cell cell-200 text-fff">주문상태</div>
                        </div>
                        <!--   BEGIN LOOP -->
                        <ul>
                        <c:forEach var="orderDetail" items="${orderDetailList}">
                            <li class="row">
                                <div class="cell cell-150">${orderDetail.order.orderdate}</div>
                                <div class="cell cell-150">${orderDetail.order.ordernum}</div>
                                <div class="cell cell-150">${orderDetail.order.name}</div>
                                <div class="cell cell-150">${orderDetail.order.member.userid}</div>
                                <div class="cell cell-150">신용카드</div>
                                <div class="cell cell-100">
                                    <input type="button" onclick="location.href='/company/orderDetail?ordernum=${orderDetail.order.ordernum}'" value="상세보기">
                                </div>
                                <c:choose>
                                	<c:when test="${orderDetail.state ne '결제완료' && orderDetail.state ne '배송준비중' && orderDetail.state ne '배송중' && orderDetail.state ne '배송완료' && orderDetail.state ne '환불신청' && orderDetail.state ne '환불완료'}">
                                		<c:if test="${orderDetail.order.amount <= 0 }">
