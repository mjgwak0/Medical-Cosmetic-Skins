            ...
            <ul class="sideMenu">
                ...
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-spray-can-sparkles"></span>제품관리</a>
                    <ul class="submenu" style="display: block;">
                        ...
                        <li><a href="/company/ProductIngredients" style="background: rgba(255,255,255,0.5);"><span class="fa fa-magnifying-glass"></span>원료정보</a></li>                                     
                    </ul>
                </li>
...
<!--                            <div class="cell cell-100 text-fff">IMAGE</div>-->
                            <div class="cell cell-300 text-fff">제품명</div>
                            <div class="cell cell-100p text-fff">원료정보
                                <a style="font-size: 22px; color: #557daa">.</a>
                            </div>
...
<!--
                                <div class="cell cell-100">
                                    <a href=""><img src="image\sample.jpg" alt="" width="50"></a>
                                </div>
-->
                                <div class="cell cell-300"><a href="">${product.pro_name}</a></div>
                                <div class="cell cell-100p" style="text-align: inherit">${product.ingredients}</div>
<!--
                                <div class="cell cell-100">
...
-->
                                <div class="cell cell-100">
                                    <a href="/company/ProductUpdate?pronum=${product.pronum}" class="btnEdit fa fa-pencil bg-1 text-fff"></a><a href="" class="btnRemove fa fa-remove bg-1 text-fff" onclick='return confirm("Do you really want to remove it ?")'></a>
                                </div>
                            </li>
                        </ul>
                        </c:forEach>
