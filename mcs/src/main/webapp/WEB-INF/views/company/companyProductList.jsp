            ...
            <ul class="sideMenu">
                ...
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-spray-can-sparkles"></span>제품관리</a>
                    <ul class="submenu" style="display: block;">
                        <li><a href="/company/ProductList" style="background: rgba(255,255,255,0.5);"><span class="fa fa-magnifying-glass"></span>제품정보</a></li>
...
-->
                        ...
                        <a href="/company/addproductForm" class="btnAdd fa fa-plus bg-1 text-fff"></a>                        
                    </div>
                </div>
                <form action="" method="GET" name="listForm" class="form scrollX">
                    ...
                    <div class="table" style="min-width: 1600px">
                        <div class="row bg-1">
                            ...
                            <div class="cell cell-100 text-fff">CATEGORY</div>
                            ...
                            <div class="cell cell-100 text-fff">제조일자</div>
                            <div class="cell cell-100 text-fff">재고</div>
                            <div class="cell cell-100 text-fff">사용기한</div>
                            <div class="cell cell-100 text-fff">BAUMANN</div>
                            <div class="cell cell-100 text-fff"><input type="checkbox" class="checkbox checkAll" name="statusAll" target=".status"></div>
                        ...
                        <ul>
                            <li class="row">
                                <div class="cell cell-50">${product.pronum}</div>
                                <div class="cell cell-100">${product.code}</div>
                                <div class="cell cell-100">
                                    <a href="#"><img src="/images/${product.files.file_name}" alt="" width="50"></a>
                                </div>
                                <div class="cell cell-100p"><a href="">${product.pro_name}</a></div>
                                <div class="cell cell-100"><a href="">${product.price}</a></div>
                                <div class="cell cell-100"><a href="">${product.sale}</a></div>
                                <div class="cell cell-100"><a href="">${salePrice}</a></div>
                                <div class="cell cell-100"><a href="">${product.manufacture}</a></div>
                                <div class="cell cell-100"><a href="">${product.inventory}</a></div>
                                <div class="cell cell-100"><a href="">${product.expiration}</a></div>
                                <div class="cell cell-100"><a href="">${product.baumann}</a></div>
                                <div class="cell cell-100">
                                    <input type="hidden" class="status" name="status" value="0">
                                    <input type="checkbox" class="btnSwitch status" name="status">
                                </div>
                                <div class="cell cell-100">
                                    <a href="/company/ProductUpdate?pronum=${product.pronum}" class="btnEdit fa fa-pencil bg-1 text-fff"></a><a href="/company/deleteProduct?pronum=${product.pronum}" class="btnRemove fa fa-remove bg-1 text-fff" onclick='return confirm("Do you really want to remove it ?")'></a>
                                </div>
                            </li>
                        </ul>
                        </c:forEach>
