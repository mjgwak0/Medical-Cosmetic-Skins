        ...
        <div class="clear">
            <div class="happy cell-right">
                ...
                <c:forEach var="bestItem" items="${bestProduct}">
                    <ul>
                        <li><a href="/productInfo?pronum=${bestItem.pronum}">
                                <span class="img"><img src="images/${bestItem.files.file_name}"></span>
                                <span>
                                    <div class="name">${bestItem.pro_name}</div>
                                    <div class="price"><fmt:formatNumber value= "${bestItem.price-(bestItem.price*bestItem.sale/100)}" pattern="#,###" />원 
