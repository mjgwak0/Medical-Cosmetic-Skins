...
-->
                            ...
                            <div class="tab_container">
                                ...
                                <%--<section class="ee">
                                        <div class="e1">
                                            <a style="padding-right:95px;">문의번호</a>
                                            <a style="padding-right:50px;">글유형</a>
                                            <a style="padding-right:75px;">제목</a>
                                            <a style="padding-right:65px;">답변상태</a>
                                            <a style="padding-left:16px;">작성일자</a>
                                        </div>                                        
                                    </section> --%>
										<div class="e1">
											<thead>
                                    		...
                                    		<c:forEach var="board" items="${boardList}">
													...
													<details>
                                           				<summary>
                                                			...
                                                			<input type="hidden" name="pronum" value="${board.pronum}"/>
                                              	 			<button onclick="location.href='/board/getBoard?boardnum=${board.boardnum}'">수정하기</button>
                                            			</summary>
												...
												<tbody>
                                        			<tr align="center">
                                        				...
                                        				<td>${board.logtime}</td>
                                        				<td><input type="hidden" name="pronum" value="${board.pronum}"/>
                                              	 			<button onclick="location.href='/board/getBoard?boardnum=${board.boardnum}'">수정하기</button></td>
                                				    </tr>
                                         		</tbody>
											</c:forEach>
										</c:when>
										...
										<c:otherwise>
												<!-- <p style="padding-top: 50px"  align="center">문의 내역이 없습니다.</p> -->
												<table>
												<p style="padding-top: 50px"  align="center">문의 내역이 없습니다.</p>
												</table>
										</c:otherwise>
