                    ...
                    <article class="faq">
                        <div>
                            ...
                            <div class="tab_container">
                                ...
                                <form action="/mypage/confirmPwd" method="POST" class="form" id="modifyForm">
                                    <div class="formHeader row">
                                        <h2 class="text-1 fl" style="font-size: 20px; color: #557daa; font-weight: bold">회원수정 - 비밀번호 확인</h2>
                                        <div class="fr">
                                    ...
                                    <div class="formBody row">
                                        <div class="column s-5">
                                            <label class="inputGroup">
                                                <span>아이디</span>
                                                <span><input type="text" value="${member.userid}" name="userid" readonly></span>
                                            </label>
                                            <label class="inputGroup">
                                                <span>비밀번호</span>
                                                <span><input type="password" placeholder="비밀번호를 입력해주세요." id="pwCheck" name="password"></span>
                                            </label>
