                                    ...
                                    <section class="ff">
                                        <details>
                                            <summary>
                                                ...
                                                <a>${orderDetail.state}</a>
                                                <c:choose>
                                                	<c:when test="${orderDetail.state eq '결제완료'}">
                                                		<button onclick="location.href='/mypage/orderDetail?ordernum=${order.ordernum}'">취소하기</button>
                                                	</c:when>
                                                	<c:when test="${orderDetail.state eq '배송준비중'}">
                                                		<button onclick="location.href='/mypage/orderDetail?ordernum=${order.ordernum}'">환불하기</button>
                                                	</c:when>
