        ...
        <article class="join">
            <div>
                ...
                <div class="iinn2">
                    <h3>주문목록/배송조회</h3>
                    <div class="in1">
                        <p>고객의 주문 정보 및 배송 조회를 할 수 있는 페이지입니다.</p>                        
                    </div>
                            ...
                            <div class="tab_container">
                                ...
                                <div id="tab1" class="tab_content">
                                    ...
                                    <c:choose>
	                                    	...
	                                    	<c:forEach var="order" items="${orderList}">
												<section class="ff">
													<table>
														...
														<td><button onclick="location.href='/mypage/orderDetail?ordernum=${order.ordernum}'">상세주문</button></td>
														<td><button>접수하기</button></td>
													</table>
												</section>
											</c:forEach>
										</c:when>
										...
										<c:otherwise>
											<p style="padding-top: 50px"  align="center">주문 내역이 없습니다.</p>
										</c:otherwise>
									</c:choose>
                                </div>
