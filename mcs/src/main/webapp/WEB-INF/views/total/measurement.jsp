...
<head>
	...
	var chart = new Chart(ctx, {
		type: 'bar', 
		data: { labels: ['ORPW', 'OSNT', 'ORNT', 'ORNW', 'DSPT', 'DRPT','DSNT','DRNW','DSPW'
				,'DSNW','DRNT','OSPW','OSNW','OSPT','DRPW','ORPT'],
		datasets: [{ label: '바우만 테스트',
		backgroundColor: [ 'rgba(70, 163, 196, 0.5)', 'rgba(158, 194, 228, 0.5)', 'rgba(197, 107, 171, 0.5)', 'rgba(246, 154, 193, 0.5)',
			'rgba(78, 127, 185, 0.5)','rgba(177, 168, 213, 0.5)', 'rgba(241, 103, 139, 0.5)', 'rgba(243, 181, 170, 0.5)',
			'rgba(183, 210, 55, 0.5)','rgba(205, 227, 155, 0.5)','rgba(247, 149, 110, 0.5)','rgba(253, 214, 185, 0.5)',
			'rgba(131, 193, 92, 0.5)','rgba(159, 213, 189, 0.5)','rgba(251, 184, 95, 0.5)','rgba(255, 227, 162, 0.5)'],
		borderColor: ['rgb(255, 99, 132,1.5)', 'rgba(54, 162, 235, 1.5)',
			'rgba(255, 206, 86, 1.5)', 'rgba(75, 192, 192, 1.5)', 'rgba(153, 102, 255, 1.5)',
			'rgba(255, 159, 64, 1.5)'],
		data: [${skintest[0]}, ${skintest[1]}, ${skintest[2]}, ${skintest[3]}, ${skintest[4]}, ${skintest[5]},${skintest[6]},${skintest[7]},${skintest[8]},
			${skintest[9]},${skintest[10]},${skintest[11]},${skintest[12]},${skintest[13]},${skintest[14]},${skintest[15]}] }] },
		options: { title: { display: true, text: '회원별 피부유형',
            ...
            <ul class="sideMenu">
                ...
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-line-chart"></span>통계관리</a>
                    <ul class="submenu" style="display: block;">
                        ...
                        <li><a href="/totalAccount" style="background: rgba(255,255,255,0.5);"><span class="fa fa-pencil"></span>평가통계</a></li>
                    </ul>
                </li>
