        ...
        <article class="join">
            <div>
                ...
                <div class="iinn2">
                    ...
                    <div class="in1">
                        <p>고객의 1:1 문의 내역 조회를 할 수 있는 페이지입니다.</p>
<%--                         <button onclick="location.href='/getBoardList?boardnum=${board.boardnum}'">게시판이동</button> --%>
<%--                         <button><a href="/board?pronum=${boardList.pronum}">게시판이동</a></button> --%>
<%--                         --%>
<%--                           --%>
                    </div>
