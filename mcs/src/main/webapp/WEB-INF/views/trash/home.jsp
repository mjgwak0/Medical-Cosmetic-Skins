					...
					<sec:authorize access="isAuthenticated()">
						<li class="cell"><font color="red"><sec:authentication property="principal.username"/></font>님</li>
							...
							<sec:authorize access="hasRole('MANAGER')">
								<li class="cell"><a href="/logout" method="get">로그아웃</a></li>
								<li class="cell"><a href="/company/addproductForm" method="get">상품등록</a></li>
...
<!--         권한별 헤더 링크 end -->
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            ...
            <img src="image/banner1.jpg" style="width:1500px" height="500px">
<!--            <div class="text">1</div>-->
        </div>

        <div class="mySlides fade">
            <div class="numbertext">2 / 3</div>
            <img src="image/banner2.jpg" style="width:1500px" height="500px">
<!--            <div class="text">2</div>-->
        </div>

        <div class="mySlides fade">
            <div class="numbertext">3 / 3</div>
            <img src="image/banner3.jpg" style="width:1500px" height="500px">
<!--            <div class="text">3</div>-->
    ...
    <div class="clear con row">
        <div class="section recommend_tag cell" style="background:url('image/product4.jpg')">
      ...
      <div class="channel con">
        <a href="/product/productList" class="more">더보기</a>
        <div class="clear">
            <div class="happy cell-right">
                ...
                <dd>
                    <ul>
                        <li><a href="#">
                                <span class="img"><img src="image/small1.jpg"></span>
                                <span>
                                    <div class="name">저자극 각질 케어</div>
                                    <div class="price">19,800</div>
                                </span>
                            </a>
                        </li>
                        <li><a href="#">
                                <span class="img"><img src="image/small2.jpg"></span>
                                <span>
                                    <div class="name">촉촉한 남자 피부를 위한 올인원</div>
                                    <div class="price">10,500</div>
                                </span>
                            </a>
                        </li>
                        <li><a href="#">
                                <span class="img"><img src="image/small3.jpg"></span>
                                <span>
                                    <div class="name">진정 강한 당신의 크림</div>
        ...
        <div class="recommend_items">
            <ul class="row">
                ...
                <li class="cell">
                    ...
                    <div class="info-box">
                        <div class="title-area">
                            <div class="name">플레이 컬러 아이 팔레트</div>
                        </div>
                        <div class="item-option">
                            <div class="option">란제리 백스테이지</div>
                        </div>
                        <div class="price-area">
    ...
    <div class="best con">
        ...
        <div class="recommend_items">
            <ul class="row my-1 owl-carousel owl-theme">
                <li class="cell">
                    <div class="item">
                        <div class="image-box"><a href="#"><img src="image/small1.jpg"></a></div>
                        <div class="info-box">
                ...
                <li class="cell">
                    <div class="item">
                        <div class="image-box"><a href="#"><img src="image/small2.jpg"></a></div>
                        <div class="info-box">
                ...
                <li class="cell">
                    <div class="item">
                        <div class="image-box"><a href="#"><img src="image/small3.jpg"></a></div>
                        <div class="info-box">
                ...
                <li class="cell">
                    <div class="item">
                        ...
                        <div class="info-box">
                            ...
                            <div class="title-area">
                                <div class="name">리얼아트 클렌징 오일 모이스처
                                </div>
                            </div>
                            <div class="price-area">
          ...
          <footer>
              <div>
                  <section>
                      ...
                      <ul>
                          <li><img src="image/building.png">
                              서울시 송파구 오금로 311 (오금동45-1)</li>
                          <li><img src="image/tel.png">
                      ...
                      <div class="icon">
                          <img src="image/instagram.png" alt="인스타">
                          <img src="image/facebook.png" alt="페북">
